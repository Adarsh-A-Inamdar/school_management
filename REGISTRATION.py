...
firstw=Tk()
firstw.title("Sample registration form for School")
firstw.geometry("1600x1000+0+0")
label=Label(text="Sample Registration Form for School",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Sample registration form for School")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Sample registration form for School", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
